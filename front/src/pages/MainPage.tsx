...
function MainPage() {
  return (
    <div className="h-full flex flex-col items-center justify-center tracking-wider">
      ...
      <Link
        to="/profile"
        className="absolute top-16 right-10 w-1/5 flex flex-col items-center justify-center hover:scale-110"
      >
        <img src={main4} alt="내 정보" className="w-1/5 no-drag" />
        <p className="text-xl font-bold text-center pt-2">내 정보 확인하기</p>
      </Link>
      <div className="bg-secondary flex items-center justify-center w-10/12 rounded-3xl p-5 h-2/3">
        <Link
          to="/listenNews"
          className="w-1/3 flex flex-col items-center justify-between h-3/4  hover:scale-110"
        >

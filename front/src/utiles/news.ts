...
export const detail = (news_id : string) =>
  api.post(`/detail`, {news_id})
...
export const answerJ3 = (user_id : string, quiz_id : string, answer : Map<string, string>) =>
...
export const answerJ4 = (user_id : string, quiz_id : string, answer : Array<string>) =>
...
export const answerJ6 = (user_id : string, quiz_id : string, answer : Array<string>) =>
